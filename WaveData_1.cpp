...
WaveScript wave2Script[] =
{
	...
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, 0, 0, 20, 0),		// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, 0, 0, -20, 0),		// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, -20, 0, 0, 0),		// 回転刃生成 


	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::HORIZONTAL, 60, 0, 10, 3),	// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::VERTICAL, 10, 0, -60, 3),	// 回転刃生成 
...
WaveScript wave3Script[] =
{
	...
	SET_OnLight(24.0f),					// ライトON

	SET_ENEMY(26.0f, EREA1, ENEMY_2),
	SET_ENEMY(29.0f, EREA0, ENEMY_3),
	SET_ENEMY(29.0f, EREA0, ENEMY_3),

	SET_OffLight(35.0f),				// ライトOFF

	SET_OnLight(50.0f),					// ライトON
...
{
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, 30, 0, 0, 0),		// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, 0, 0, 30, 0),		// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, 0, 0, -30, 0),		// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::NO_MOVE, -30, 0, 0, 0),		// 回転刃生成 
	...
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::HORIZONTAL, 60, 0, 10, 8),	// 回転刃生成 
	SET_MARUNOKO(0.0f, ObsMarunoko::MarunokoType::VERTICAL, 10, 0, -60, 8),	// 回転刃生成 
